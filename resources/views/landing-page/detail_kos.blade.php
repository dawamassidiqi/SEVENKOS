...
@section('detail_kos')
    ...
    <body>
        {{-- detail foto kos --}}
        <div style="display: flex; padding:10px 10px; position: relative;">
                ...
                <div class="card-sewa" style="text-align: center;">
                    ...
                    <div style="display: flex;">
                        ...
                        <div class="dropdown">
                            <button class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown"
                                aria-expanded="false" style="background: rgba(41, 46, 73, 0.50);">
                                Per Bulan
                            </button>
                    ...
                    <div class="d-grid gap-2">
                        <button class="btn" type="button"
                            style="background: rgba(41, 46, 73, 0.50);  font-size: 13px;"><a href=""
                                style="font-size: 13px;">Tanya Pemilik</a></button>
                        <button class="btn" type="button" style=" background-color: #FC6767; font-size: 13px;">Ajukan
                            Sewa</button>
                    </div>
                </div>
            </form>
                        ...
                        <a href="{{ route('detail-kos') }}">
                            <div class="card-img-overlay">
                                <p style="text-align:end;"><span
                                        style="background-color: #FC6767; padding:5px; border-radius:5px; color:white;">Campur</span>
                                </p>
                                <br>
                                <br>
                                <br>
