...
{{-- babarsari --}}
<div class="babarsari" id="babarsari">
  <div class="col-sm-3" style="margin: 5px;">
    <div class="card">
...
{{-- condong catur --}}
<div class="condong-catur" id="condong-catur">
  <div class="col-sm-3" style="margin: 5px;">
    <div class="card">
      <img src="assets/Rectangle 9 (4).png" class="card-img" alt="gambar">
      <a href="{{ route('detail-kos') }}">
...
{{-- demangan --}}
<div class="demangan" id="demangan">
  <div class="col-sm-3" style="margin: 5px;">
    <div class="card">
      <img src="assets/Rectangle 9 (4).png" class="card-img" alt="gambar">
      <a href="{{ route('detail-kos') }}">
...
{{-- taman siswa --}}
<div class="taman-siswa" id="taman-siswa">
  <div class="col-sm-3" style="margin: 5px;">
    <div class="card">
      <img src="assets/Rectangle 9 (4).png" class="card-img" alt="gambar">
      <a href="{{ route('detail-kos') }}">
...
{{-- maguwoharjo --}}
<div class="maguwoharjo" id="maguwoharjo">
